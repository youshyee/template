...
def get_args_parser():
    ...
    parser.add_argument('--istblog', type=bool, default=True,
    ...
    parser.add_argument('--launcher', default='pytorch', type=str,
                        choices=['pytorch', 'slurm'], help='distributed launch method')
    parser.add_argument('--dist_url', default='env://',
                        help='url used to set up distributed training')

    # frequency of things
    parser.add_argument('--freq_checkpoint', default=1, type=int)
...
def main(args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if epoch % args.freq_checkpoint == 0 and epoch != 0 or epoch + 1 == args.epochs:
            util.save_model(
